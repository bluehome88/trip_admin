...
var app = angular
  ...
  .config(['$stateProvider', '$urlRouterProvider', function($stateProvider, $urlRouterProvider) {
    ...
    // reports/person
    .state('app.reports.person', {
      controller: 'ReportPersonCompleteCtrl',
      url: '/person/:userID',
      templateUrl: 'views/pages/reports-person.html'
    })
    // reports/detail
    .state('app.reports.detail', {
      controller: 'ReportDetailCtrl',
      url: '/detail/:reportID',
      templateUrl: 'views/pages/reports-detail.html'
    })
...
app
  .controller('MainCtrl', function ($scope, $http, $translate, $state) {
    ...
    $scope.logout = function(){
      var res = $http.get( api_url + "logout");
...
app
  ...
  .controller('Map2Ctrl', function($scope) {
    $scope.map = {center: {latitude: 40.1451, longitude: -99.6680 }, zoom: 8, bounds: {}
    };
    $scope.options = {scrollwheel: false};
